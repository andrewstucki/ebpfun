  ...
  config.vm.define "web", autostart: false do |machine|
    ...
    service_config = {
      annotations: {
        ...
        "consul.hashicorp.com/connect-service-upstreams": "api:1234",
        ...
        write_files:
          - path: /srv/consul/fake-service.env
            ...
            content: |
              ...
              UPSTREAM_URIS="http://localhost:1234"
        EOF
  end

  # Create a client machine which registers a service running on port 9090
  (1..3).each do |i|
